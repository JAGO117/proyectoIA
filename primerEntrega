...
def obtenerDatosArchivo():
    ...
    if entradaSeparador.get() == "," and estadoEncabezado.get() == 1:
        datosArchivo = pd.read_csv(rutaArchivo)
    elif entradaSeparador.get() == "," and estadoEncabezado.get() == 0:
        datosArchivo = pd.read_csv(rutaArchivo, header = None)
    elif entradaSeparador.get() == "" and estadoEncabezado.get() == 1:
